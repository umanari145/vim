...
if has('printer')
  if has('win32')
    set printfont=MS_Mincho:h18:cSHIFTJIS
...
set ts=4 sts=4 sw=4 tw=0 expandtab 
"番号をふる
set number
...
"Java辞書ファイル
set dictionary=vim73/dict/j2se131.dict
...
"smartyをhtmlとして認識させるために(主にオートインデント)
au BufRead,BufNewFile *.tpl set filetype=html

"プロジェクトのプラグインを読み込む
source $VIM/vim73/plugin/project.vim

set modifiable
set write
"Copyright (C) 2008 KaoriYa/MURAOKA Taro
